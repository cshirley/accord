...
| `git_review_context` | Standalone review ladder (local staged+unstaged vs HEAD → branch); writes full diff to a temp file and returns `repo_root`, `diff_path`, `file_list`, `source_alias`, `local_layers`, and test hints |
