...
type RenderCallArgs = SubagentParamsInput;
type RenderCallTheme = Parameters<
  NonNullable<ToolDefinition<typeof SubagentParams, SubagentDetails>["renderCall"]>
>[1];
type RenderResultArgs = Parameters<
  NonNullable<ToolDefinition<typeof SubagentParams, SubagentDetails>["renderResult"]>
>;

export function renderSubagentCall(args: RenderCallArgs, theme: RenderCallTheme) {
...
export function renderSubagentResult(
  ...
  options: RenderResultArgs[1],
  theme: RenderResultArgs[2],
) {
